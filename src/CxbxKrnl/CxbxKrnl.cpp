...
extern "C" CXBXKRNL_API void CxbxKrnlCleanup(const char *szErrorMessage, ...)
{
    ...
    if(szErrorMessage != NULL)
    {
		...
		// blueshogun 9/30/07
		// I changed MB_ICONSTOP back to MB_ICONEXCLAMATION because whenever I hear
		// the noise associated with it, I assume it's an exception and it turns
		// out to be a fatal message.  Highly annoying!
