    ...
    if(pLibraryVersion != 0)
    {
        ...
        for(int p=0;UnResolvedXRefs < LastUnResolvedXRefs;p++)
        {
            ...
            for(uint32 v=0;v<dwLibraryVersions;v++)
            {
				...
				if(BuildVersion == 3944) { BuildVersion = 3911; }
				if(BuildVersion == 4039) { BuildVersion = 4034; }
				if(BuildVersion == 4531) { BuildVersion = 4627; }
				...
				if(BuildVersion == 3948) { BuildVersion = 3925; }
				/*
				...
				*/
                ...
                if(bXRefFirstPass)
                {
                      ...
                      || BuildVersion == 4627 || BuildVersion == 5558 || BuildVersion == 5849))
                    {
						...
						// Locate IDirect3D8_CreateDevice for XDK 4831
						{
						}
                    }
                }
