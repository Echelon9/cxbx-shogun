...
// * CMcpxBuffer_Stop
// ******************************************************************
SOOVPA<13> CMcpxBuffer_Stop_1_0_4928 =
{
    0,  // Large == 0
    13, // Count == 11

    XREF_DirectSound_CMcpxBuffer_Stop,		// XRef Is Saved
    1,										// XRef Is Used

    {
		// CMcpxBuffer_Stop_1_0_4928+0x04 : mov eax, [esi+0x90]
		{ 0x04, 0x8B },
		{ 0x05, 0x86 },
		{ 0x06, 0x90 },
		{ 0x07, 0x00 },
...
// ******************************************************************
//SOOVPA<0> CDirectSound::GetOutputLevels_1_0_4627
//{
//	0,	// Large == 0
//	0,	// Count == ?
// ******************************************************************
...
OOVPATable DSound_1_0_4627[] =
{
	...
	// CMcpxBuffer_Stop
	{
		(OOVPA*)&CMcpxBuffer_Stop_1_0_4928, 
			
		XTL::EmuCMcpxBuffer_Stop,
