...
// ******************************************************************
SOOVPA<12> IDirect3DDevice8_SetVerticalBlankCallback_1_0_5849 =
{
    0,  // Large == 0
    12, // Count == 12
...

    {
        ...
        // IDirect3DDevice8_SetVerticalBlankCallback+0x0A : mov [ecx+0x1DB8], eax
        { 0x0A, 0x89 }, // (Offset,Value)-Pair #7
        { 0x0B, 0x81 }, // (Offset,Value)-Pair #8
        { 0x0C, 0xB8 }, // (Offset,Value)-Pair #9
        { 0x0D, 0x1D }, // (Offset,Value)-Pair #10
...
OOVPATable D3D8_1_0_5849[] =
{
	...
	// IDirect3DDevice8::SetShaderConstantMode (* unchanged since 5558 *)
	{
	...
	// IDirect3DDevice8::SetViewport (* unchanges since 5558 *)
	{
